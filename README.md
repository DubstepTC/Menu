### Для чего нужно?
Приложение создано для того чтобы искать инофрмацию по банку решений арбитражного суда https://ras.arbitr.ru по ключевым словам.
Т.к встроенный поиск ищет информацию с учетом сколений падежей и т.п. то выборка становиться слишком большой, приложение создано для отделения нужных нам записей от всего остального
